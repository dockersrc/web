# Docker image for web using the alpine template
ARG IMAGE_NAME="web"
ARG PHP_SERVER="web"
ARG BUILD_DATE="202601292017"
...
ARG IMAGE_REPO="casjaysdev/web"
ARG IMAGE_VERSION="latest"
ARG CONTAINER_VERSION=""

ARG PULL_URL="linuxserver/webtop"
ARG DISTRO_VERSION="arch-i3"
...
ARG PACK_LIST="bash curl wget procps xfce4 xfce4-goodies xfce4-terminal xfce4-screensaver xfce4-notifyd xfce4-power-manager xfce4-settings xfce4-session xfce4-panel xfce4-whiskermenu-plugin thunar thunar-volman thunar-archive-plugin file-roller gvfs mousepad ristretto parole network-manager-applet firefox evince man-db man-pages xdg-utils xdg-user-dirs pavucontrol ttf-dejavu ttf-liberation noto-fonts noto-fonts-emoji p7zip neofetch which base-devel git sudo"
...
ENV HOSTNAME="casjaysdevdocker-web"
